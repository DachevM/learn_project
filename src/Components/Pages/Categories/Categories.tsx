...
import {addCategory, remove} from "../../../Redux/action-creators/categoryAction";
    ...
    return (
        <div className={"categories"}>
            <div className={"categories_head"}>
                ...
                <button className={"categories_butt"} onClick={newCategories}>Добавить категорию</button>
            </div>
            <div>
                    ...
                    <div className={"categories_data"}>
                        {categories.map((elem) =>
                            <div key={elem.id} className={"categories_body_data"}>
                                <div onClick={() => setSelected(elem)}
                                     className={"categories_body_data_name"}>{elem.name}</div>
                                <div>
                                    <img className={"categories_pen"} src={Img.pen} alt={""} />
                                    <img className={"categories_trash"} src={Img.trash} alt={""} onClick={() => removeCategory(elem)}/>
                                </div>
                            </div>
                        )}
                    </div>
