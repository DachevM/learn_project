    ...
    return (
        <div className={"orders_modal_descr"}>
            <div className={"orders_descr_head"}>
                <button onClick={()=>setShow(false)} className={"order_butt_close"}>Закрыть</button>
                <button onClick={()=>setShow(false)} className={"order_butt_confirm"}>Подтвердить</button>
            </div>
            <div className={"orders_descr_body"}>
                <div className={"edit_descr"}>
                    ...
                    <input type={"text"}
                           ...
                           className={"orders_descr_inp"}/>
                    <label form={"demo-select-small"}>{order.delivery_type ==="DELIVERY" ? "Пункт доставки" :"Пункт самовывоза" }</label>
                    <input type={"text"}
                    ...
                    <label form={"demo-select-small"}>Дополнительная информация по оплате</label>
                    <input type={"text"}
                ...
                <div className={"orders_products"}>
                    <div className={"orders_ins_product"}><span>Крем</span><span>SKUOO2</span></div>
                    <div className={"orders_ins_product"}><span>Количество</span><span>1</span></div>
                    <div className={"orders_ins_product"}><span>Биостимулирующий дневной крем</span><span></span></div>
                    <div className={"orders_ins_product"}><span>100 мл</span><span>4 576 $</span></div>
                </div>
                <h4 className={"orders_descr_change"}>Изменить</h4>
                <p>Сумма заказа</p>
                <div className={"orders_products"}>
                    <div className={"orders_ins_product"}><span>Товары</span><span>9134 $</span></div>
                    <div className={"orders_ins_product"}><span>Скидки</span><span>883 $</span></div>
                    <div className={"orders_ins_product"}><span>Сумма наличных бонусов</span><span>888 $</span></div>
                    <div className={"orders_ins_product_price"}><span>Итого</span><span>{order.total} $</span></div>
                </div>
            </div>
        </div>
    );
